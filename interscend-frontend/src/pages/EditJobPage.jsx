...
const EditJobPage = () => {
    ...
    const [wordCount, setWordCount] = useState(0);
      ...
      const handleDescriptionChange = (e) => {
        ...
        setWordCount(words.length); // Update word count first
        if (words.length <= 100) {
            setDescription(input); // Only update description if within limit
        }
      };
          ...
          <form onSubmit={submitForm}>
            ...
            <div className="mb-4">
              <label
                ...
                >Description (100 words max)</label
              >
              <textarea
                id="description"
                name="description"
                className={`border rounded w-full py-2 px-3 ${isLimitReached ? "border-red-500" : ""}`}
                rows="4"
